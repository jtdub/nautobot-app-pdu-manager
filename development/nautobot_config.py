...
# nautobot_plugin_nornir must be enabled: pdu_manager uses its Nautobot ORM inventory
# and Secrets-based credentials to SSH into APC PDUs.
...
PLUGINS_CONFIG = {
    "nautobot_plugin_nornir": {
        "nornir_settings": {
            # Read SSH credentials from each PDU Device's assigned SecretsGroup.
